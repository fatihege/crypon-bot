    ...
    async run(message, client) {
        ...
        if (command.permissions) {
            ...
            if (!authorPerms || !authorPerms.has(command.permissions)) {
                return message.channel.send(`**Bunu yapamazsın ${message.author}!** Yeterli yetkin yok.`);
            }
        }
        ...
        try {
            ...
            console.error(error);
            message.channel.send(`Bu komut çalıştırılırken bir hata meydana geldi.`);
        }
    }
}